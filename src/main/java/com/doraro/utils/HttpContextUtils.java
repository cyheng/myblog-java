...
public class HttpContextUtils {
    ...
    public static <T> Object getBean(ServletContext cs, Class<T> requiredType) {
        return WebApplicationContextUtils.getRequiredWebApplicationContext(cs).getBean(requiredType);
    }
